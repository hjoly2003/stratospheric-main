...
public class NetworkApp {
  ...
  public static void main(final String[] args) {
    ...
    Stack networkStack = new Stack(app, "NetworkStack", StackProps.builder()
      // [N] We use the environmentName in the stackName() method to prefix the name of the stack. This separates the stack and the other resources from those deployed in another environment.
