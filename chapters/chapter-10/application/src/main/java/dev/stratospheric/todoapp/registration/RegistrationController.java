...
public class RegistrationController {
   ...
   * @param registration
   * @param bindingResult Used to ensure that our model matches our validation rules: no empty email or username (as definded through the {@code @NotBlank} annotation in the {@link Registration} model).
   * @param model
  ...
  public String registerUser(@Valid Registration registration,
    ...
    // Ensures that our model matches our validation rules: no empty email or username (as definded through the @NotEmpty annotation in the Registration model).
