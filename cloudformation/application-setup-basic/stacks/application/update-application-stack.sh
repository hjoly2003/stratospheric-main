...
aws s3 cp ./ s3://hjolystratos.net/stacks/application --recursive
...
aws cloudformation update-stack \
  ...
  --parameters \
    ParameterKey=NetworkStackTemplateUrl,ParameterValue=https://s3.amazonaws.com/hjolystratos.net/stacks/application/network.yml \
    ParameterKey=MessagingStackTemplateUrl,ParameterValue=https://s3.amazonaws.com/hjolystratos.net/stacks/application/messaging.yml \
    ParameterKey=ServiceStackTemplateUrl,ParameterValue=https://s3.amazonaws.com/hjolystratos.net/stacks/application/service.yml \
